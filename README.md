...
- 🔍 [Recursos de Estudo:]() links e materiais recomendados para o estudo da Certificação da AI-900.
- 💻 [Projetos e Desafios:]() códigos e exercícios práticos realizados durante a bootcamp.
- 🔗 [Links Úteis:]() links, artigos e documentação oficial (Material de grande importância para o exame AI-900).

### 🔍 Recursos de Estudo
Aqui você encontrará uma lista de recursos úteis para se preparar para o exame AI-900:

- [Artigo sobre o Exame AI-900]()
- [Curso gratuito para Certificação AI-900]()
- [Material de Estudo]()
